...
public class SpNetworkUtil {
    private static final String SP_NAME = "app_network_config";
    ...
    private static SharedPreferences getSp() {
        return NetworkSession.get().getContext().getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
    }
