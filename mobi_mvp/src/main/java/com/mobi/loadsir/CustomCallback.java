...
public class CustomCallback extends Callback {
    ...
    protected int onCreateView() {
        return ResourceUtil.getIdentifierLayout("loadsir_layout_custom");
    }
    ...
    protected boolean onReloadEvent(final Context context, View view) {
        ...
        (view.findViewById(ResourceUtil.getIdentifierId("iv_gift"))).setOnClickListener(new View.OnClickListener() {
            @Override
