...
public class DownloadFileManager {
    private static IFileConnect fileConnect;

    public static void init(IFileConnect connect) {
        fileConnect = connect;
    }
    ...
    public static void download(final String path,
                                ...
                                final IDownloadFileCallBack callBack) {
        final FileDownload fileDownload = new FileDownload(path, targetFilePath, threadCount, fileConnect);
