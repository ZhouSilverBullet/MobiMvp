...
import com.mobi.thrid.images.config.AnimationMode;
import com.mobi.thrid.images.config.GlobalConfig;
import com.mobi.thrid.images.config.PriorityMode;
import com.mobi.thrid.images.config.ScaleMode;
import com.mobi.thrid.images.config.ShapeMode;
import com.mobi.thrid.images.config.SingleConfig;
import com.mobi.thrid.images.utils.DownLoadImageService;
import com.mobi.thrid.images.utils.ImageUtil;
...
//            request.transition(GenericTransitionOptions.with(config.getAnimation()));
//        }
    }
...
//        Glide.with(GlobalConfig.context).onDestroy();
